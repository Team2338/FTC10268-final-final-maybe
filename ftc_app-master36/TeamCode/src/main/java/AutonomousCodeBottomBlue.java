...
public class AutonomousCodeBottomBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (runtime.seconds() >= 0 && runtime.seconds() < 30) {
            ...
            if (runtime.seconds() >= 6 && runtime.seconds() < 8.95) {
            ...
            if ((runtime.seconds() >= 8.95) && (runtime.seconds() < 28)) {
                ...
                backRightMotor.setPower(0);
                Thread.sleep(100);
                Glyph1.setPosition(0.4);
                Glyph2.setPosition(0.6);
                Thread.sleep(100);
                frontLeftMotor.setPower(0.5);
                frontRightMotor.setPower(-0.5);
                backLeftMotor.setPower(0.5);
                ...
                backRightMotor.setPower(0);
                Thread.sleep(200);
                Glyph1.setPosition(.4);
                Glyph2.setPosition(.6);
                Thread.sleep(500);
                frontLeftMotor.setPower(-0.5);
                frontRightMotor.setPower(0.5);
                backLeftMotor.setPower(-0.5);
